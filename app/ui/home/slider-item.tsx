...
const SliderItem = ({itemName, itemPrice}: { itemName: string, itemPrice: number }) => {
	return (
		<>
			<Link className="relative h-full w-full bg-black text-white" href="/">
				<div className="group flex h-full w-full overflow-hidden relative border border-neutral-50 rounded-xl">
